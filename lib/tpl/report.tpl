...
<body>
  ...
  <script src="http://ecma.bdimg.com/lego-mat/static/libs/d3.v3.min.js"></script>
  <script src="http://ecma.bdimg.com/lego-mat/static/libs/underscore-min.js"></script>
  <script src="http://ecma.bdimg.com/lego-mat/static/libs/jquery.min.js"></script>

  <script>
  var getGraphData = function() { return ${structure};};
